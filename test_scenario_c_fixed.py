#!/usr/bin/env python3
"""
Scenario C (AFTER FIXES): Complete onboarding, refresh, ask question
Expected: Chat should stay open, course should be remembered
"""
import time
...
with sync_playwright() as p:
    ...
    screenshot_dir = "test_scenario_c_fixed"
    os.makedirs(screenshot_dir, exist_ok=True)
    
    print("[SCENARIO C - FIXED] Complete onboarding, refresh, ask question")
    print("="*60)
    ...
    # Try to send message
    print("\n[TEST] Sending 'Fees structure' after refresh...")
    ...
    if messages:
        ...
        if has_bca and not has_multiple_courses:
            print("\n✅ SCENARIO C FIXED - Chat persists, course remembered after refresh")
        else:
            print("\n❌ SCENARIO C STILL BROKEN")
    else:
        print("\n❌ No messages found - chat not working")
