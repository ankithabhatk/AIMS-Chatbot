...
export const AdmissionContact: React.FC = () => {
  return (
    <div className="admission-contact">
      <div className="contact-label">Admission Department</div>
      <div className="contact-info">
        <a href="mailto:admission@theaims.ac.in" className="contact-link">
